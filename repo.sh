...
ssh_repos=(
    "git@github.com:edx-solutions/cs_comments_service.git"
    "git@github.com:mckinseyacademy/mcka_apros.git"
    "git@github.com:edx-solutions/edx-platform.git"
    "git@github.com:mckinseyacademy/mcka-theme.git"
)
...
reset ()
{
    ...
    do
        ...
        if [ -d "$name" ]; then
            cd "$name";git reset --hard HEAD;git checkout juniper-rebase;git reset --hard origin/master;git pull;cd "$currDir"
        else
